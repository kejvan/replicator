// One Dark Theme Color Palette
// Based on original Atom One Dark UI theme

// Theme Metadata
const themeMetadata = {
  name: 'Replicant One Dark',
  fileName: 'replicant-one-dark.json',
  uiTheme: 'vs-dark'
};

// UI Colors - Used for VS Code interface elements
const uiColors = {
  // Base colors from original Atom One Dark
  background: '#282c34',           // main background
  backgroundLighter: '#2c313c',    // slightly lighter variant
  backgroundDarker: '#21252b',     // side areas
  foreground: '#abb2bf',           // main foreground
  foregroundMuted: '#4b5363',      // syntax gutter color
  foregroundDimmed: '#5c6370',     // comments color variant

  // Accent and interaction colors
  accent: '#528bff',               // original syntax accent
  accentMuted: '#3c6eb4',          // badge background
  border: '#181a1f',               // original border color

  // Selection and highlighting
  selection: '#3e4451',            // selection background
  selectionHighlight: '#2c323c',   // secondary selection
  currentLine: '#2c323c',          // current line highlight

  // Status colors using original hues
  highlight: '#e5c07b',            // hue-6-2 (orange 2)
...
const syntaxColors = {
  // Base syntax colors
  comment: '#5c6370',              // same as uiColors.foregroundDimmed
